...
struct Dict_s {
    Path** paths;             /**< all the existing paths */
    short** preds;
    int max_m1;               /**< max size of the Dictionnary */
    int max_m0;
    int nb_add;
};
...
extern void Dict_init(Dict_t* dic, int size, int msd);


extern void Dict_reset(Dict_t* dic);
...
extern void Dict_add(Dict_t* dic, my_m0 key_seg, my_m1 key_cost, my_m2 value, int currDag, int lastSegment, short pred);
