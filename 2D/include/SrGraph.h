...
/**
 * @brief load a Segment Routing from a binary file
 */
...
SrGraph_t* SrGraph_load_with_label(char* filename, int accuracy, char biDir, LabelTable_t* labels);
